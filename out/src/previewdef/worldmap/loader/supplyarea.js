...
class SupplyAreasLoader extends common_1.FolderLoader {
    ...
    loadImpl(session) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.fireOnProgressEvent((0, i18n_1.localize)('worldmap.progress.loadingsupplyareas', 'Loading supply areas...'));
    ...
    mergeFiles(fileResults, session) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.fireOnProgressEvent((0, i18n_1.localize)('worldmap.progress.mapstatetosupplyarea', 'Mapping states to supply areas...'));
...
class SupplyAreaLoader extends common_1.FileLoader {
    loadFromFile() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const warnings = [];
            return {
                result: yield loadSupplyArea(this.file, warnings),
                warnings,
            };
        });
    }
...
function loadSupplyArea(file, globalWarnings) {
    var _a, _b;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const result = [];
        try {
            const data = yield (0, fileloader_1.readFileFromModOrHOI4AsJson)(file, supplyAreaFileSchema);
            for (const supplyArea of data.supply_area) {
                ...
                const value = (_a = supplyArea.value) !== null && _a !== void 0 ? _a : 0;
                ...
                result.push({
                    ...
                    value,
                    file,
                    token: (_b = supplyArea._token) !== null && _b !== void 0 ? _b : null,
                });
            }
        }
        catch (e) {
...
function statesAreAdjacent(stateA, stateB, provinces) {
    return stateA.provinces.some(p => {
        var _a, _b;
        return (_b = (_a = provinces[p]) === null || _a === void 0 ? void 0 : _a.edges.some(e => e.type !== 'impassable' && stateB.provinces.some(p2 => provinces[p2] && e.to === p2))) !== null && _b !== void 0 ? _b : false;
    });
}
