...
async function loadProvincesBmp(provincesFile, progressReporter, warnings) {
    await progressReporter((0, i18n_1.localize)('worldmap.progress.loadingprovincebmp', 'Loading province bmp...'));
    const [provinceMapImageBuffer] = await (0, fileloader_1.readFileFromModOrHOI4)(provincesFile);
    const provinceMapImage = (0, bmpparser_1.parseBmp)(provinceMapImageBuffer.buffer, provinceMapImageBuffer.byteOffset);
    await progressReporter((0, i18n_1.localize)('worldmap.progress.calculatingregion', 'Calculating province region...'));
    ...
    await progressReporter((0, i18n_1.localize)('worldmap.progress.calculatingedge', 'Calculating province edges...'));
