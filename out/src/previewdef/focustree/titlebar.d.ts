...
export declare const goalsOverlaysGfxFile = "interface/goals_overlays.gfx";
...
export declare function getFocusOverlayImage(overlay: string | undefined): Promise<Image | undefined>;
