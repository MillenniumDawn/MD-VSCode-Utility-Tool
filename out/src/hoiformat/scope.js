...
exports.scopeDefs = exports.tryMoveScope = exports.countryScope = void 0;
const common_1 = require("../util/common");
const schema_1 = require("./schema");
exports.countryScope = { scopeName: '', scopeType: 'country' };
function tryMoveScope(node, scopeStack, type) {
    ...
    const variableMatch = schema_1.variableRegexForScope.exec(node.name.trim());
    if (variableMatch) {
        let global = false;
    ...
    const scopeDef = exports.scopeDefs[nodeName];
