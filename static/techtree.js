...
function folderChange(folder) {
    ...
    (0,_util_common__WEBPACK_IMPORTED_MODULE_0__.setState)({ folder: folder });
...
window.addEventListener('load', (0,_util_common__WEBPACK_IMPORTED_MODULE_0__.tryRun)(function () {
    ...
    const folder = (0,_util_common__WEBPACK_IMPORTED_MODULE_0__.getState)().folder || element.value;
    element.value = folder;
    folderChange(folder);
    (0,_util_common__WEBPACK_IMPORTED_MODULE_0__.scrollToState)();
    (0,_util_common__WEBPACK_IMPORTED_MODULE_0__.subscribeRefreshButton)();
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["common"], () => (__webpack_require__("./webviewsrc/techtree.ts")))
