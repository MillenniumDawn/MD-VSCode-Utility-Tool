(self["webpackChunkhearts_of_iron_4_utilities_2026"] = self["webpackChunkhearts_of_iron_4_utilities_2026"] || []).push([["common"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   applyCondition: () => (/* binding */ applyCondition),
/* harmony export */   conditionToString: () => (/* binding */ conditionToString),
/* harmony export */   extractConditionFolder: () => (/* binding */ extractConditionFolder),
/* harmony export */   extractConditionValue: () => (/* binding */ extractConditionValue),
/* harmony export */   extractConditionValues: () => (/* binding */ extractConditionValues),
/* harmony export */   extractConditionalExprs: () => (/* binding */ extractConditionalExprs),
/* harmony export */   simplifyCondition: () => (/* binding */ simplifyCondition)
/* harmony export */ });
/* harmony import */ var _tostring__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tostring */ "./src/hoiformat/tostring.ts");
/* harmony import */ var _scope__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scope */ "./src/hoiformat/scope.ts");
...
function extractConditionFolder(nodeValue, scopeStack, type = 'and', excludedKeys = undefined, amount = 0) {
    ...
    for (const child of nodeValue) {
        ...
        if (childName === 'and' || childName === 'hidden_trigger') {
        ...
        else if ((0,_scope__WEBPACK_IMPORTED_MODULE_1__.tryMoveScope)(child, scopeStack, 'condition')) {
            items.push(extractConditionFolder(child.value, scopeStack));
            scopeStack.pop();
        }
        else {
            items.push({
                ...
                nodeContent: (0,_tostring__WEBPACK_IMPORTED_MODULE_0__.nodeToString)(child),
            });
        }
        if (!keepIfItem) {
            if (ifItem) {
...
function applyCondition(condition, trueExprs) {
    ...
    if (!('items' in condition)) {
        return trueExprs.some(e => (0,lodash__WEBPACK_IMPORTED_MODULE_2__.isEqual)(condition, e));
    }
...
function extractConditionalExprs(condition, result = []) {
    ...
    if (!('items' in condition)) {
        if (result.every(e => !(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isEqual)(e, condition))) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   convertNodeToJson: () => (/* binding */ convertNodeToJson),
/* harmony export */   forEachNodeValue: () => (/* binding */ forEachNodeValue),
/* harmony export */   isSymbolNode: () => (/* binding */ isSymbolNode),
/* harmony export */   parseNumberLike: () => (/* binding */ parseNumberLike),
/* harmony export */   positionSchema: () => (/* binding */ positionSchema),
/* harmony export */   toNumberLike: () => (/* binding */ toNumberLike),
/* harmony export */   toStringAsSymbolIgnoreCase: () => (/* binding */ toStringAsSymbolIgnoreCase),
/* harmony export */   variableRegex: () => (/* binding */ variableRegex),
/* harmony export */   variableRegexForScope: () => (/* binding */ variableRegexForScope)
/* harmony export */ });
...
//#endregion
const variableRegex = /^(?:(?<prefix>\w+):)?(?<scope>(?:\w+\.)*)?(?<var>\w+)(?:@(?<target>(?:\w+\.)*\w+))?(?:\?(?<default>\d+))?$/;
const variableRegexForScope = /^(?:(?<prefix>\w+):)(?<scope>(?:\w+\.)*)?(?<var>\w+)(?:@(?<target>(?:\w+\.)*\w+))?$/;
//#region Functions
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   countryScope: () => (/* binding */ countryScope),
/* harmony export */   scopeDefs: () => (/* binding */ scopeDefs),
/* harmony export */   tryMoveScope: () => (/* binding */ tryMoveScope)
/* harmony export */ });
/* harmony import */ var _util_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/common */ "./src/util/common.ts");
/* harmony import */ var _schema__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./schema */ "./src/hoiformat/schema.ts");


const countryScope = { scopeName: '', scopeType: 'country' };
function tryMoveScope(node, scopeStack, type) {
    var _a, _b;
    if (!node.name) {
        return false;
    }
    ...
    if (nodeName.match(/^from$/) && (currentScope === null || currentScope === void 0 ? void 0 : currentScope.scopeType) === 'mio') {
        scopeStack.push({
    ...
    const variableMatch = _schema__WEBPACK_IMPORTED_MODULE_1__.variableRegexForScope.exec(node.name.trim());
    if (variableMatch) {
        let global = false;
        const prefix = (_a = variableMatch.groups) === null || _a === void 0 ? void 0 : _a.prefix.toLowerCase();
        if (prefix === 'global_event_target' || prefix === 'event_target') {
            global = true;
        }
        else if (prefix === 'var') {
            const scope = (_b = variableMatch.groups) === null || _b === void 0 ? void 0 : _b.scope;
            if (scope) {
...
function scopeDef(name, condition, effect, from, to) {
    return { name, condition, effect, from, to };
}
const scopeDefs = (0,_util_common__WEBPACK_IMPORTED_MODULE_0__.arrayToMap)([
...
/* harmony export */   debounceByInput: () => (/* binding */ debounceByInput),
/* harmony export */   forceError: () => (/* binding */ forceError),
...
function debounceByInput(func, keySelector, wait, debounceSettings) {
    ...
    function result(...input) {
        ...
        const newMethod = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.debounce)((input2) => {
...
function randomString(length, charset = undefined) {
    var result = '';
    var characters = charset !== null && charset !== void 0 ? charset : 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
...
/* harmony export */   calculateStartLength: () => (/* binding */ calculateStartLength),
/* harmony export */   getHeight: () => (/* binding */ getHeight),
/* harmony export */   getWidth: () => (/* binding */ getWidth),
/* harmony export */   normalizeMargin: () => (/* binding */ normalizeMargin),
/* harmony export */   normalizeNumberLike: () => (/* binding */ normalizeNumberLike),
/* harmony export */   removeHtmlOptions: () => (/* binding */ removeHtmlOptions)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderGridBoxCommon: () => (/* binding */ renderGridBoxCommon),
/* harmony export */   renderGridBoxConnection: () => (/* binding */ renderGridBoxConnection),
/* harmony export */   renderLineConnections: () => (/* binding */ renderLineConnections)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common */ "./src/util/hoi4gui/common.ts");
...
function renderGridBoxCommon(gridBox, parentInfo, options, onRenderBackground) {
    ...
    return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
        const [x, y, width, height, orientation] = (0,_common__WEBPACK_IMPORTED_MODULE_0__.calculateBBox)(gridBox, parentInfo);
        const format = (_b = (_a = gridBox.format) === null || _a === void 0 ? void 0 : _a._name) !== null && _b !== void 0 ? _b : 'up';
        const size = { width, height };
        const xSlotSize = (_c = (0,_common__WEBPACK_IMPORTED_MODULE_0__.normalizeNumberLike)((0,_common__WEBPACK_IMPORTED_MODULE_0__.getWidth)(gridBox.slotsize), 0)) !== null && _c !== void 0 ? _c : 50;
        const ySlotSize = (_d = (0,_common__WEBPACK_IMPORTED_MODULE_0__.normalizeNumberLike)((0,_common__WEBPACK_IMPORTED_MODULE_0__.getHeight)(gridBox.slotsize), 0)) !== null && _d !== void 0 ? _d : 50;
        ...
        const renderedItems = yield Promise.all(Object.values(options.items).map((item) => (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
...
function renderControlConnections(items, format, slotSize, size, onRenderLineBox, styleTable, childrenParentInfo) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
        ...
        return (yield Promise.all((0,lodash__WEBPACK_IMPORTED_MODULE_1__.flatMap)(controlMatrix, m => (0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)(m, (item) => (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   StyleTable: () => (/* binding */ StyleTable),
/* harmony export */   normalizeForStyle: () => (/* binding */ normalizeForStyle)
/* harmony export */ });
class StyleTable {
    constructor() {
        this.records = {};
...
/* harmony export */   enableCheckboxes: () => (/* binding */ enableCheckboxes)
/* harmony export */ });
...
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./event */ "./webviewsrc/util/event.ts");
...
class Checkbox extends _event__WEBPACK_IMPORTED_MODULE_0__.Subscriber {
    ...
    addEventHandlersForCheckBox(checkboxContainer, checkbox) {
        ...
        this.addSubscription((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.fromEvent)(checkboxContainer, 'click').subscribe((e) => {
            e.preventDefault();
            e.stopPropagation();
            toggleValue();
        }));
        this.addSubscription((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.fromEvent)(checkboxContainer, 'keydown').subscribe((e) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   arrayToMap: () => (/* reexport safe */ _src_util_common__WEBPACK_IMPORTED_MODULE_4__.arrayToMap),
/* harmony export */   copyArray: () => (/* binding */ copyArray),
/* harmony export */   enableZoom: () => (/* binding */ enableZoom),
/* harmony export */   getState: () => (/* binding */ getState),
/* harmony export */   scrollToState: () => (/* binding */ scrollToState),
/* harmony export */   setState: () => (/* binding */ setState),
/* harmony export */   subscribeNavigators: () => (/* binding */ subscribeNavigators),
/* harmony export */   subscribeRefreshButton: () => (/* binding */ subscribeRefreshButton),
/* harmony export */   tryRun: () => (/* binding */ tryRun)
/* harmony export */ });
/* harmony import */ var _dropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dropdown */ "./webviewsrc/util/dropdown.ts");
/* harmony import */ var _checkbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkbox */ "./webviewsrc/util/checkbox.ts");
/* harmony import */ var _vscode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vscode */ "./webviewsrc/util/vscode.ts");
/* harmony import */ var _telemetry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./telemetry */ "./webviewsrc/util/telemetry.ts");
/* harmony import */ var _src_util_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../src/util/common */ "./src/util/common.ts");
...
function setState(obj) {
    ...
    _vscode__WEBPACK_IMPORTED_MODULE_2__.vscode.setState(state);
}
function getState() {
    return _vscode__WEBPACK_IMPORTED_MODULE_2__.vscode.getState() || {};
}
        ...
        try {
            ...
            if (result instanceof Promise) {
                return result.catch(e => {
                    console.error(e);
                    (0,_telemetry__WEBPACK_IMPORTED_MODULE_3__.sendException)((0,_src_util_common__WEBPACK_IMPORTED_MODULE_4__.forceError)(e));
                });
            }
            return result;
        }
...
function navigateText(start, end, file) {
    _vscode__WEBPACK_IMPORTED_MODULE_2__.vscode.postMessage({
        command: 'navigate',
        start,
        end,
        file,
...
function subscribeRefreshButton() {
    ...
    button === null || button === void 0 ? void 0 : button.addEventListener('click', function () {
        _vscode__WEBPACK_IMPORTED_MODULE_2__.vscode.postMessage({ command: 'reload' });
...
window.addEventListener('load', function () {
    ...
    subscribeNavigators();
    (0,_dropdown__WEBPACK_IMPORTED_MODULE_0__.enableDropdowns)();
    (0,_checkbox__WEBPACK_IMPORTED_MODULE_1__.enableCheckboxes)();
    _dropdown__WEBPACK_IMPORTED_MODULE_0__.numDropDownOpened$.subscribe(num => {
...
/* harmony export */   enableDropdowns: () => (/* binding */ enableDropdowns),
/* harmony export */   numDropDownOpened$: () => (/* binding */ numDropDownOpened$)
/* harmony export */ });
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./event */ "./webviewsrc/util/event.ts");
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./i18n */ "./webviewsrc/util/i18n.ts");
/* harmony import */ var _checkbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checkbox */ "./webviewsrc/util/checkbox.ts");
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/internal/observable/fromEvent.js");
...
const dropdowns = [];
const numDropDownOpened$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(0);
...
class Dropdown extends _event__WEBPACK_IMPORTED_MODULE_0__.Subscriber {
    constructor(select) {
        super();
        this.select = select;
    ...
    init() {
        this.addSubscription((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(this.select, 'mousedown').subscribe(e => {
            e.preventDefault();
            this.select.focus();
        ...
        this.addSubscription((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(this.select, 'keydown').subscribe(e => {
            if (e.code === 'Enter') {
                e.preventDefault();
                if (this.closeDropdown) {
                    this.closeDropdown();
    ...
    showSelectionsForDropdown() {
        ...
        options.forEach(option => {
            ...
            if (!option.hidden) {
                optionForDropdownMenu.push({
                    text: (_a = option.textContent) !== null && _a !== void 0 ? _a : '',
                    value: option.value,
        ...
        dropdownMenuSubscriptions.push((0,_event__WEBPACK_IMPORTED_MODULE_0__.toDisposable)(dropdownMenu.options$.subscribe(options => {
            var _a;
            ...
            (_a = this.closeDropdown) === null || _a === void 0 ? void 0 : _a.apply(this);
            setTimeout(() => this.select.focus(), 0);
        })));
        dropdownMenuSubscriptions.push((0,_event__WEBPACK_IMPORTED_MODULE_0__.toDisposable)(dropdownMenu.close$.subscribe(isKey => {
            var _a;
            if (isKey) {
                this.select.focus();
            }
...
class DivDropdown extends _event__WEBPACK_IMPORTED_MODULE_0__.Subscriber {
    constructor(select, multiSelection = false) {
        super();
        this.select = select;
        this.multiSelection = multiSelection;
        this.closeDropdown = undefined;
        this.selectedValues$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject([]);
        this.init();
    ...
    updateSelectedValue(options) {
        ...
        valueSpan.textContent = selectedOptions.length === 0 ? (0,_i18n__WEBPACK_IMPORTED_MODULE_1__.feLocalize)('combobox.noselection', '(No selection)') :
            selectedOptions.length === options.length ? (0,_i18n__WEBPACK_IMPORTED_MODULE_1__.feLocalize)('combobox.all', '(All)') :
                selectedOptions.length > 1 ? (0,_i18n__WEBPACK_IMPORTED_MODULE_1__.feLocalize)('combobox.multiple', '{0} (+{1})', selectedOptions[0].text, selectedOptions.length - 1) :
                    selectedOptions[0].text;
    }
}
class DropdownMenu extends _event__WEBPACK_IMPORTED_MODULE_0__.Subscriber {
    constructor(options, multiSelection = false) {
        super();
        this.options = options;
        this.multiSelection = multiSelection;
        this.items = [];
        this.subscriptionWhenOpen = [];
        this.list = this.createList();
        this.writableOptions$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
        this.options$ = this.writableOptions$;
        this.writableClose$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
    ...
    hide() {
        var _a;
        (_a = this.list.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(this.list);
    ...
    createDropdownItem(option, index, items) {
        ...
        if (this.multiSelection) {
            ...
            const checkboxItem = new _checkbox__WEBPACK_IMPORTED_MODULE_2__.Checkbox(checkbox, option.text);
            this.addSubscription(checkboxItem);
            (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(checkbox, 'change').subscribe(() => {
                option.selected = checkbox.checked;
                this.writableOptions$.next(this.options);
            });
            (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(item, 'click').subscribe((e) => {
                if (e.target === item) {
                    checkbox.click();
                }
            });
            (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(item, 'keydown').subscribe((e) => {
            ...
            (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(item, 'click').subscribe(updateValue);
            (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(item, 'keydown').subscribe((e) => {
                if (e.code === 'Enter') {
                    e.preventDefault();
                    updateValue();
        ...
        (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(item, 'mouseenter').subscribe(() => {
            item.focus();
        });
        (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(item, 'keydown').subscribe((e) => {
    ...
    registerEventHandlerWhenOpen(host) {
        ...
        this.subscriptionWhenOpen.push((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(window, 'blur').subscribe(() => {
            closeDropdown();
        }));
        this.subscriptionWhenOpen.push((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(window, 'focusin').subscribe((e) => {
            if (!(this.list.contains(e.target) || host.contains(e.target))) {
                closeDropdown();
            }
        }));
        this.subscriptionWhenOpen.push((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(window, 'mousedown').subscribe((e) => {
            if (!(this.list.contains(e.target) || host.contains(e.target))) {
                closeDropdown();
            }
        }));
        this.subscriptionWhenOpen.push((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(window, 'keydown').subscribe((e) => {
            if (e.code === 'Escape') {
                closeDropdown(true);
            }
        }));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Subscriber: () => (/* binding */ Subscriber),
/* harmony export */   toBehaviorSubject: () => (/* binding */ toBehaviorSubject),
/* harmony export */   toDisposable: () => (/* binding */ toDisposable)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/internal/BehaviorSubject.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/internal/observable/fromEvent.js");
...
function toBehaviorSubject(element, initialValue) {
    ...
    const disposables = [];
    const observable = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(element.value);
    let changing = false;
    ...
    disposables.push((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.fromEvent)(element, 'change').subscribe(() => {
        if (changing) {
            return;
        }
        changing = true;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   feLocalize: () => (/* binding */ feLocalize)
/* harmony export */ });
let table = {};
try {
...
/* harmony export */   sendException: () => (/* binding */ sendException)
/* harmony export */ });
/* harmony import */ var _vscode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vscode */ "./webviewsrc/util/vscode.ts");
...
const sendEvent = (...args) => {
    ...
    _vscode__WEBPACK_IMPORTED_MODULE_0__.vscode.postMessage(telemetryMessage);
};
