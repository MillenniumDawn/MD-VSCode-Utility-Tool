...
let selectedMioIndex = Math.min(mios.length - 1, (_b = (0, common_1.getState)().selectedMioIndex) !== null && _b !== void 0 ? _b : 0);
...
function buildContent() {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const minX = (_b = (_a = (0, lodash_1.minBy)(Object.values(traitPosition), 'x')) === null || _a === void 0 ? void 0 : _a.x) !== null && _b !== void 0 ? _b : 0;
        const leftPadding = gridbox.position.x._value - Math.min(minX * window.xGridSize, 0);
        const traitPreviewContent = yield (0, gridboxcommon_1.renderGridBoxCommon)(Object.assign(Object.assign({}, gridbox), { position: Object.assign(Object.assign({}, gridbox.position), { x: (0, schema_1.toNumberLike)(leftPadding) }) }), {
