...
class AdjacenciesLoader extends common_1.FileLoader {
    loadFromFile() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const warnings = [];
            return {
                result: yield loadAdjacencies(this.file, e => this.fireOnProgressEvent(e), warnings),
                warnings,
            };
        });
    }
...
function loadAdjacencies(adjacenciesFile, progressReporter, warnings) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield progressReporter((0, i18n_1.localize)('worldmap.progress.loadingadjacencies', 'Loading adjecencies...'));
        const [adjecenciesBuffer] = yield (0, fileloader_1.readFileFromModOrHOI4)(adjacenciesFile);
