...
class RiverLoader extends common_1.FileLoader {
    loadFromFile() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const warnings = [];
            return {
                result: yield loadRivers(this.file, e => this.fireOnProgressEvent(e), warnings),
                warnings,
            };
        });
    }
    extraMesurements(result) {
        return Object.assign(Object.assign({}, super.extraMesurements(result)), { riverCount: result.result.rivers.length });
    }
    toString() {
...
function loadRivers(file, progressReporter, warnings) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        progressReporter((0, i18n_1.localize)('worldmap.progress.loadingrivers', 'Loading rivers...'));
        const [riversImageBuffer] = yield (0, fileloader_1.readFileFromModOrHOI4)(file);
