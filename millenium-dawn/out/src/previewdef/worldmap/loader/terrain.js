...
class TerrainFileLoader extends common_1.FileLoader {
    loadFromFile() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return {
                result: yield loadTerrains(this.file),
                warnings: [],
            };
        });
    }
...
function loadTerrains(file) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const data = yield (0, fileloader_1.readFileFromModOrHOI4AsJson)(file, terrainFileSchema);
        return Object.values(data.categories._map).map(v => {
            var _a;
            const name = v._key;
            const color = (0, common_1.convertColor)(v._value.color);
            const isNaval = (_a = v._value.naval_terrain) !== null && _a !== void 0 ? _a : false;
