...
class PreviewManager {
    constructor() {
        ...
        this._previewProvidersMap = (0, common_1.arrayToMap)(this._previewProviders, 'type');
        this._updateSubscriptions = new Map();
        this.updatePreviewItemsInSubscription = (0, common_1.debounceByInput)((uri) => {
        ...
        this.updatePreviewItem = (0, common_1.debounceByInput)((previewItem, document) => {
    ...
    deserializeWebviewPanel(panel, state) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const uriStr = state === null || state === void 0 ? void 0 : state.uri;
            if (!uriStr) {
                panel.dispose();
            ...
            try {
                ...
                yield this.showPreviewImpl(uri, panel);
            }
            catch (e) {
                (0, debug_1.error)(e);
                panel.dispose();
    ...
    onCloseTextDocument(document) {
        ...
        if (!vscode.window.visibleTextEditors.some(e => e.document.uri.toString() === document.uri.toString())) {
            ...
            (_a = this._previews[key]) === null || _a === void 0 ? void 0 : _a.panel.dispose();
    ...
    showPreviewImpl(requestUri, panel) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let document;
            ...
            if (document === undefined) {
                if (requestUri === undefined) {
                    ...
                    vscode.window.showErrorMessage((0, i18n_1.localize)('preview.cantfinddoc', "Can't find opened document {0}.", requestUri === null || requestUri === void 0 ? void 0 : requestUri.toString()));
                }
            ...
            panel = panel !== null && panel !== void 0 ? panel : vscode.window.createWebviewPanel(constants_1.WebviewType.Preview, (0, i18n_1.localize)('preview.viewtitle', "HOI4: {0}", filename), vscode.ViewColumn.Beside, {
                enableScripts: true
            });
