...
exports.registerScanReferencesCommand = exports.getDependenciesFromText = void 0;
...
function getDependenciesFromText(text) {
    ...
    while (match) {
        const type = (_a = match.groups) === null || _a === void 0 ? void 0 : _a.type;
        const ext = (_b = match.groups) === null || _b === void 0 ? void 0 : _b.ext;
        if (type && (type === ext || ext === 'txt' || ext === 'yml')) {
            const path = (_c = match.groups) === null || _c === void 0 ? void 0 : _c.path;
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (context_1.contextContainer.contextValue[constants_1.ContextName.Hoi4PreviewType] === 'event') {
                yield scanReferencesForEvents(editor);
...
function scanReferencesForEvents(editor) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const eventFiles = yield (0, fileloader_1.listFilesFromModOrHOI4)('events');
        const document = editor.document;
        const events = (yield Promise.all(eventFiles.map((file) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const filePath = 'events/' + file;
                const [buffer, realPath] = yield (0, fileloader_1.readFileFromModOrHOI4)(filePath);
        ...
        const localizationFiles = yield (0, fileloader_1.listFilesFromModOrHOI4)('localisation');
        const language = (0, vsccommon_1.getLanguageIdInYml)();
        const localizations = (yield Promise.all(localizationFiles.map((file) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
