...
exports.parseBmp = void 0;
const common_1 = require("../../common");
function parseBmp(buffer, byteOffset) {
    const uint8Buffer = new Uint8Array(buffer, byteOffset);
    if (uint8Buffer[0] !== 0x42 || uint8Buffer[1] !== 0x4D) {
        throw new common_1.UserError("Bmp not starts with 'BM'");
    }
...
exports.parseBmp = parseBmp;
//# sourceMappingURL=bmpparser.js.map