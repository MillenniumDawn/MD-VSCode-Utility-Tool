...
- [ World Map Previewer ] The province map and the file parser now build their data in typed steps, so a bug in either fails loudly instead of showing a broken preview. Issue #52.
