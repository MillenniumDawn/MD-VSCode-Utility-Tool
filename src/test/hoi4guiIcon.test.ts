...
describe('util/hoi4gui/icon', () => {
    ...
    it('renders sprite when resolved', async () => {
        ...
        const fakeSprite: any = { width: 32, height: 32, image: fakeImage, frames: fakeImage.frames, uri: 'file:///fake.png' };
        const html = await renderIcon(icon, parent(), {
            styleTable: table,
    ...
    it('applies centerposition offset', async () => {
        ...
        const fakeSprite: any = { width: 20, height: 20, uri: 'file:///a.png', frames: [{ x: 0, y: 0, width: 20, height: 20, uri: 'file:///a.png' }] };
    ...
    it('uses quadtexturesprite fallback', async () => {
        ...
        const fakeSprite: any = { width: 10, height: 10, uri: 'file:///q.png', frames: [] };
        const html = await renderIcon(icon, parent(), {
            styleTable: styleTable(),
