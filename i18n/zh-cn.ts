...
const table: Partial<typeof __table> = {
    ...
    "decisiontree.collapse": "折叠此分类",
    "decisiontree.collapsecategories": "折叠分类",
    ...
    "decisiontree.hiddencount": "已隐藏{0}个",
    "decisiontree.hiddentitle": "折叠此分类后隐藏的项：{0}",
