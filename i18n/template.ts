...
const table: Partial<typeof __table> = {
    ...
    "techtree.countrynoindex": "GFX index is off — country icons can't be listed. Enable the GFX index setting to pick a country.",
    ...
    "worldmap.error.provinceimagebpp": "The provinces image should be 24 bits per pixel, but it is {0}.",
